...
export const THEMES: Record<string, ThemePalette> = {
  "premium-grok": withWarn({
    ...
    selection: "rgba(200,150,80,0.24)",
    terminal: {
      ...darkTerminal,
      black: "#08080c",
      brightBlack: "#747484",
  ...
  midnight: withWarn({
    ...
    scrollbar: "rgba(248,250,252,0.24)",
    scrollbarHover: "rgba(248,250,252,0.38)",
    selection: "rgba(85,170,221,0.24)",
    terminal: {
